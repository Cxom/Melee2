...
public class FireworkUtils {
	...
	public static Firework spawnFirework(Location loc, MeleeColor color, int power){ return spawnFirework(loc, color.getBukkitColor(), power); }
	...
	public static Firework spawnFirework(Location loc, MeleeColor primary, MeleeColor secondary, int power){ return spawnFirework(loc, primary.getBukkitColor(), secondary.getBukkitColor(), power); }
